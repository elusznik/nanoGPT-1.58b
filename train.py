...
use_bitlinear = True # use ternary BitLinear instead of vanilla nn.Linear
# adamw optimizer
...
model_args = dict(n_layer=n_layer, n_head=n_head, n_embd=n_embd, block_size=block_size,
                  bias=bias, vocab_size=None, dropout=dropout, use_bitlinear=use_bitlinear) # start with model_args from command line
if init_from == 'scratch':
    ...
    for k in ['n_layer', 'n_head', 'n_embd', 'block_size', 'bias', 'vocab_size', 'use_bitlinear']:
